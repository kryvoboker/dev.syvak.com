...
import {
    addClass, fetchFunc, findElem, httpBuildQueryString,
    isEmpty, scrollToTop, setHistoryState, toggleElement
...
const processLoadMoreProducts = (): void => {
    ...
    loadMoreProductsBtnEl?.addEventListener('click', function (this: HTMLButtonElement): void {
        ...
        let nextPage: number           = WINDOW_APP_PARAMS.next_page ?? 0;
        ...
        fetchFunc(LOAD_MORE_PRODUCTS_AJAX_URL + '?' + urlQueries, {}, 'GET')
