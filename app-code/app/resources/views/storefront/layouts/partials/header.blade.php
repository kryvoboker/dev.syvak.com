@include('storefront.pages.partials.common.main-mob-menu')
@include('storefront.pages.partials.common.main-pc-menu')
@include('storefront.pages.partials.search.mob-search')
@include('storefront.pages.partials.search.pc-search')
        ...
        <div class="container">
            <div class="flex items-center justify-between gap-x-1">
                <button class="burger-menu open-main-mob-menu-btn lg:hidden"
                        ...
                        aria-expanded="false"
                        aria-controls="{{ __('storefront/default.aria_labels.toggle_main_menu') }}">
                ...
                <div class="hidden lg:flex lg:items-center lg:justify-between lg:gap-x-8 uppercase">
                    <button class="open-main-pc-menu-btn uppercase"
                        ...
                        {{ __('storefront/default.buttons.catalog') }}
                    </button>
                ...
                <div class="flex items-center justify-between gap-x-7">
                    <x-storefront::common.language-swithcer class="hidden md:inline-flex"
