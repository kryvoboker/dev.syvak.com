...
{{--                            @if(true)--}}
                    ...
                    @if(filled(data_get($support, 'working_hours.title', __('catalog/failure.support.working_hours'))) && filled(data_get($support, 'working_hours.content')))
                        <x-catalog::contacts.working-hours
                            :working_hours="data_get($support, 'working_hours', [])"
                            :fallback_title="__('catalog/failure.support.working_hours')"
