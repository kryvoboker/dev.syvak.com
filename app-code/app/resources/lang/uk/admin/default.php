...
return [
    ...
    'columns' => [
        ...
        'image' => 'Зображення',
        'is_active' => 'Активний',
        'show_in_header' => 'Відображається в хедері',
    ...
    'labels' => [
        ...
        'date_added' => 'Дата додавання',
        'is_active' => 'Активний',
        'show_in_header' => 'Показувати в хедері',
        'is_default' => 'За замовчуванням',
        'name' => 'Назва',
        'format_locale' => 'Формат локалі',
        'code' => 'Код',
        ...
        'slug' => 'Slug (SEO URL)',
        'svg_icon' => 'SVG іконка',
        'products' => "Пов'язані з цією категорією продукти",
    ],
    ...
    'helpers' => [
        ...
        'show_in_header' => 'Визначає, чи буде ця категорія відображатися серед посилань хедера на користувацькій частині сайту.',
    ...
    'errors' => [
        ...
        'min_search_length' => 'Мінімальна кількість символів для пошуку :length!'
    ],
];
