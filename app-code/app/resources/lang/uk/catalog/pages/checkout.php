...
return [
    ...
    'map' => [
        'title' => 'Оберіть точку доставки',
        'search_placeholder' => 'Пошук за назвою або адресою',
        'list_title' => 'Доступні точки доставки',
        'empty' => 'Немає доступних точок доставки',
        'deliver_here' => 'Доставити сюди',
        'close' => 'Закрити',
