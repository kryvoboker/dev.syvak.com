...
return [
    ...
    'cart' => [
        ...
        'errors' => [
            ...
            'promo_not_eligible' => 'Цей промокод недоступний для вас.',
            'promo_expired' => 'Термін дії промокоду ще не почався або вже завершився.',
            'promo_minimum_order' => 'Сума замовлення замала для застосування промокоду.',
            'promo_usage_limit' => 'Ліміт використання промокоду вичерпано.',
        ],
        'validation' => [
