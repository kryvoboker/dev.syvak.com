...
return [
    'products_carousel' => [
        'sections' => [
            ...
            'category_products' => 'Selected variants from selected categories',
            'manual_only_window' => 'Only selected product variants',
        ],
        'labels' => [
            ...
            'use_selected_products_only' => 'Show only specific variants',
            'search_products_in_selected_categories' => 'Live search in selected category variants',
            'search_all_active_products' => 'Live search in all active variants',
            'selected_products' => 'Selected product variants',
        ...
        'options' => [
            'source_mode' => [
                ...
                'manual_only' => 'Only selected variants',
            ],
            'sort_mode' => [
        ...
        'helpers' => [
            ...
            'manual_only_window' => 'Select any active variants from the full active catalog.',
            'search_products_in_selected_categories' => 'Search by product name, SKU, model, or EAN. Add == price to match a regular or active discount price. Only active variants from selected categories are shown.',
            'search_all_active_products' => 'Search by product name, SKU, model, or EAN. Add == price to match a regular or active discount price. Only active variants are shown.',
            'selected_products' => 'Use checkboxes to keep or remove product variants from the final module output.',
        ],
    ],
];
