...
namespace ProjectStandard\Sniffs\Naming;
...
final class NamingConventionSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    private function checkVariable(\PHP_CodeSniffer\Files\File $file, int $ptr): void
    {
    ...
    private function checkFunctionOrMethod(\PHP_CodeSniffer\Files\File $file, int $ptr): void
    {
        $tokens = $file->getTokens();
    ...
    private function checkClassLike(\PHP_CodeSniffer\Files\File $file, int $ptr): void
    {
        $tokens = $file->getTokens();
    ...
    private function checkConstants(\PHP_CodeSniffer\Files\File $file, int $ptr): void
    {
        $tokens = $file->getTokens();
    ...
    private function checkEnumCase(\PHP_CodeSniffer\Files\File $file, int $ptr): void
    {
        $tokens = $file->getTokens();
    ...
    private function isAnonymousClass(\PHP_CodeSniffer\Files\File $file, int $ptr): bool
    {
        $tokens = $file->getTokens();
