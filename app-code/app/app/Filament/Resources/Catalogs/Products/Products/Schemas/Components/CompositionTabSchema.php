...
class CompositionTabSchema
{
    ...
    {
        return Tab::make(__('admin/catalogs/products/products.tabs.composition'))
            ->schema([
                Section::make(__('admin/catalogs/products/products.sections.composition_block'))
                    ->schema([
                        Tabs::make('ProductCompositionLanguageTabs')
    ...
    private static function buildLanguageTabs(Collection $active_languages): array
    {
        return $active_languages
            ->map(function (Language $language): Tab {
                $section_path = "composition_and_care_data.translations.$language->id.composition";
