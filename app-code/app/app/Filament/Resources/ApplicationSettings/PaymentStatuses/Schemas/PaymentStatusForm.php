...
namespace App\Filament\Resources\ApplicationSettings\PaymentStatuses\Schemas;
            ...
            $translation_tabs[] = Tabs\Tab::make($language->name)
                ...
                ->schema([
                    TextInput::make("descriptions.$language->id.name")
                        ->label(__('admin/settings/payment_statuses.labels.name'))
                        ->maxLength(255)
                        ->required(),
                ]);
        }
                ...
                Tabs::make('PaymentStatusTabs')
                    ->tabs([
                                ...
                                Section::make(__('admin/default.sections.basic_info'))
                                    ->schema([
                                        TextInput::make('code')
                                            ...
                                            ->helperText(__('admin/settings/payment_statuses.helpers.code'))
                                            ->maxLength(100)
                                            ->required()
                                        ...
                                        Toggle::make('is_default')
                                            ...
                                            ->helperText(__('admin/settings/payment_statuses.helpers.is_default'))
                                            ->default(false)
                                            ->live()
                                        ...
                                        Toggle::make('is_active')
                                            ...
                                            ->helperText(__('admin/settings/payment_statuses.helpers.is_active'))
                                            ->default(true)
                                            ->required(),
                                    ])
                                    ->columns(2),
                        ...
                        Tabs\Tab::make(__('admin/default.tabs.translations'))
                            ->schema([
                                Tabs::make('PaymentStatusLanguageTabs')
