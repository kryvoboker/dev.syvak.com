...
namespace App\Filament\Resources\PageSettings\Failure;

use App\Filament\Navigation\AdminNavigationGroupEnum;
use App\Filament\Resources\PageSettings\Failure\Pages\EditFailure;
use App\Filament\Resources\PageSettings\Failure\Schemas\FailureForm;
...
class FailureResource extends Resource
{
    ...
    {
        return FailureForm::configure($schema);
    }
    ...
    {
        return __('admin/settings/failure_page_settings.labels.model');
    }

    public static function getPluralModelLabel(): string
    {
        return __('admin/settings/failure_page_settings.labels.plural_model');
    }
