...
namespace App\Filament\Resources\PageSettings\Contacts;

use App\Filament\Navigation\AdminNavigationGroupEnum;
use App\Filament\Resources\PageSettings\Contacts\Pages\EditContacts;
use App\Filament\Resources\PageSettings\Contacts\Schemas\ContactsForm;
...
class ContactsResource extends Resource
{
    ...
    {
        return __('admin/settings/contacts_page_settings.labels.model');
    }

    public static function getPluralModelLabel(): string
    {
        return __('admin/settings/contacts_page_settings.labels.plural_model');
    }
