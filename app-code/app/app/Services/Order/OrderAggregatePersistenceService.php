...
final class OrderAggregatePersistenceService
{
    ...
    public function createSimpleOrder(
        ...
        return DB::transaction(function () use ($validated_data, $cart_data, $locale, $request_context): array {
            ...
            $this->createShipping($order, $validated_data);
            ...
            $payment = $order->payments()->create([
                'method' => (string) Arr::get($validated_data, 'payment_method', ''),
                'code' => (string) Arr::get($validated_data, 'payment_method', ''),
     ...
     * @param array<string, mixed> $validated_data
     */
    private function createShipping(Orders $order, array $validated_data): OrderShippings
    {
        ...
        return $order->shipping()->create([
            'method' => $this->nullableString(Arr::get($validated_data, 'delivery_method')),
